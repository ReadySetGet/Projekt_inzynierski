"""Package containing data models for the fuzzy inference systems (fis) used.

This package contains:
- Counter model for basic functionality
- FIS (Fuzzy Inference System) models for fuzzy logic operations
