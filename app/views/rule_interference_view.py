...
class RuleInterferenceTabWidget(BaseTabView):
    ...
    def __init__(self, parent=None, status_bar=None):
        """Initialize the rule interference tab widget.
    ...
    def _retranslate_ui(self):
        ...
        self.name_label.setText(self.t("PLACEHOLDER"))
        self.input_values_label.setText(self.t("INPUT_VALUES"))

        self.input_values_edit.setText(self.t(f"{self.slider_1_value}, {self.slider_2_value}"))
        self.input_1_label.setText(
            self.t(
                '<html><head/><body><p><span style=" font-weight:600;">'
                f"Input 1 = {self.slider_1_value}</span></p></body></html>"
            )
        )
        self.input_2_label.setText(
            self.t(
                '<html><head/><body><p><span style=" font-weight:600;">'
        ...
        self.output_label.setText(
            self.t('<html><head/><body><p><span style=" font-weight:600;">Output 1 = 50</span></p></body></html>')
        )
