"""Add an interactive trapezoid plot element to the plot widget.

    Classes:
        TrapezoidPlot: a class responsible for plotting an interacting plot to a given pyqtgraph plot widget element.
"""
import pyqtgraph as pg


class TrapezoidPlot:
    """Class representing a trapezoid plot.
        ...
        Methods:
            __init__(pq.PlotWidget(), list[float], list[float], string):
                create an instance of TrapezoidPlot.
    ...
    def _left_down_trap_interaction(self) -> None:
        """Move the left down anchor of the plot. Disallows moving beyond position 0 and the left up anchor."""
    ...
    def _left_up_trap_interaction(self) -> None:
        """Move the left up anchor of the plot. Disallows moving beyond left down anchor and the right up anchor."""
    ...
    def _right_up_trap_interaction(self) -> None:
        """Move the right up anchor of the plot. Disallows moving beyond right down anchor and the left up anchor."""
    ...
    def _right_down_trap_interaction(self) -> None:
        """Move the down up anchor of the plot. Disallows moving beyond the point 100 and the right up anchor."""
