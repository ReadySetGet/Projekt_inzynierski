"""Base class for all frame views with dependency injection for AppContext."""
...
class BaseFrameView(QFrame):
    """Base class for all frame views with AppContext dependency injection.
    ...
    def __init__(
        ...
        """Initialize the BaseFrameView with an optional context and QSS filename.
        ...
        if context is not None:
            ...
            raise RuntimeError(
                "No AppContext provided or set as provider for BaseFrameView."
            )
