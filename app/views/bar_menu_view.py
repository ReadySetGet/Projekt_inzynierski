...
"""Class responsible for the menu on top of the main window.

Responsible for easy access to most essential functions of the application.
"""
...
class BarMenuWidget(QtWidgets.QMenuBar):
    ...
    def __init__(self, parent=None):
        """Initialize the menu bar widget.
    ...
    def _setup_ui(self):
        """Set up the main menu categories.

        Menu refers to the 'main' categories under which certain actions fall.
        Menu items are visible at all times on the bar.
        """
