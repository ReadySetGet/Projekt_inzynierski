...
class BarMenuWidget(QtWidgets.QMenuBar):
    ...
    def _setup_ui(self):
        ...
        self.action_save = QtGui.QAction(parent=self.main_window)
        self.action_save.setObjectName("action_save")

        self.action_import = QtGui.QAction(parent=self.main_window)
        self.action_import.setObjectName("action_import")

        self.action_export = QtGui.QAction(parent=self.main_window)
        self.action_export.setObjectName("action_export")

        self.action_mamdani = QtGui.QAction(parent=self.main_window)
        self.action_mamdani.setObjectName("action_mamdani")

        self.action_sugeno = QtGui.QAction(parent=self.main_window)
        self.action_sugeno.setObjectName("action_sugeno")

        self.action_clear_inputs = QtGui.QAction(parent=self.main_window)
        self.action_clear_inputs.setObjectName("action_clear_inputs")

        self.action_clear_outputs = QtGui.QAction(parent=self.main_window)
        self.action_clear_outputs.setObjectName("action_clear_outputs")

        self.action_mamdani_to_sugeno = QtGui.QAction(parent=self.main_window)
        self.action_mamdani_to_sugeno.setObjectName("action_mamdani_to_sugeno")

        self.action_sugeno_to_mamdani = QtGui.QAction(parent=self.main_window)
        self.action_sugeno_to_mamdani.setObjectName("action_sugeno_to_mamdani")

        self.actionPlaceholder = QtGui.QAction(parent=self.main_window)
        self.actionPlaceholder.setObjectName("actionPlaceholder")

        self.actionPlaceholder_2 = QtGui.QAction(parent=self.main_window)
