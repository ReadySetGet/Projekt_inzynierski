...
class ModelValidationMamdaniTestCase(unittest.TestCase):
    ...
    def test_model_validation(self) -> None:
        ...
        self.assertEqual(type(self.model._fis), fl.mamfis,
        ...
        self.assertEqual(result, 1, "Wrong return value")
        self.assertEqual(self.model._fis.AggregationMethod, "probor",
                         "Aggregation method not updated")

        result = self.model.change_defuzzification_method("lom")
        self.assertEqual(self.model._fis.DefuzzificationMethod, "lom",
