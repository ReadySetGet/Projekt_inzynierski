...
class UpdateRuleTestCase(unittest.TestCase):
    ...
    def test_1_rule_weight_updated(self) -> None:
        ...
        self.assertEqual(
            self.model._fis.Rules[0].Weight, 0.5, "Rule weight not updated"
        )
    ...
    def test_3_rule_connection_updated(self) -> None:
        ...
        self.assertEqual(
            self.model._fis.Rules[0].Connection, 0, "Rule connection not updated"
        )
    ...
    def test_6_rule_used_mf_updated(self) -> None:
        ...
        self.assertEqual(
            self.model._fis.Rules[0].Antecedent[0], 2, "Rule mf not updated"
        )
