...
class AddRuleTestCase(unittest.TestCase):
    ...
    def test_1_default_value_correct(self) -> None:
        self.assertEqual(self.model._interpolation_points_nr, 100,
    ...
    def test_2_set_interpolation_points_number(self) -> None:
        ...
        self.assertEqual(result, 1,
                         "Problems with return value")
        self.assertEqual(self.model._interpolation_points_nr, 999,
                         "Interpolation points set incorrectly")
