...
class ConvertInferenceSystemMamdaniToSugenoTestCase(unittest.TestCase):
    ...
    def test_1_convert_from_mamdani_to_sugeno(self) -> None:
        ...
        self.assertEqual(new_model._fis.Rules[0].IsMFOutput, [1],
                         "IS NOT not changed")
        self.assertEqual(new_model._fis.Outputs[0].MembershipFunctions[0]
                         .Parameters, 0.5, "Wrong parameter conversion")
