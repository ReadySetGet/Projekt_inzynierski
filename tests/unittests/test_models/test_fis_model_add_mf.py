...
class AddMFTestCase(unittest.TestCase):
    ...
    def test_3_mf_name_input(self) -> None:
        ...
        self.assertEqual(
            self.model._fis.Inputs[0].MembershipFunctions[0].Name,
            "mf0",
            "Wrong name of MF added to input",
        )
    ...
    def test_5_mf_type_input(self) -> None:
        self.model.add_mf("input0", "input")
        self.assertEqual(
            self.model._fis.Inputs[0].MembershipFunctions[0].Type,
            "trimf",
            "Wrong type of MF added to input",
        )

    def test_6_mf_name_output(self) -> None:
        self.model.add_mf("output0", "output")
        self.assertEqual(
            self.model._fis.Outputs[0].MembershipFunctions[0].Name,
            "mf0",
            "Wrong name of MF added to output",
        )
    ...
    def test_8_mf_type_output(self) -> None:
        ...
        self.assertEqual(
            ...
            "trimf",
            "Wrong type of MF added to output",
        )

    def test_9_no_io_variable_with_given_name(self) -> None:
        result = self.model.add_mf("output4", "output")
        self.assertEqual(result, -1, "Wrong result code")
    ...
    def test_11_wrong_mf_type(self) -> None:
        ...
        self.assertEqual(result, -2, "Wrong result code")
