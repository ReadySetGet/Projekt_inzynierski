...
def test_left_down_anchor_interaction_valid(plot_instance, qtbot):
    ...
    plot_instance.trapezoid_left_down_anchor.sigPositionChanged.emit(plot_instance.trapezoid_left_down_anchor)
...
def test_left_up_anchor_interaction_valid(plot_instance, qtbot):
    ...
    plot_instance.trapezoid_left_up_anchor.sigPositionChanged.emit(plot_instance.trapezoid_left_up_anchor)
...
def test_right_up_anchor_interaction_valid(plot_instance, qtbot):
    ...
    plot_instance.trapezoid_right_up_anchor.sigPositionChanged.emit(plot_instance.trapezoid_left_up_anchor)
...
def test_right_down_anchor_interaction_valid(plot_instance, qtbot):
    ...
    plot_instance.trapezoid_right_down_anchor.sigPositionChanged.emit(plot_instance.trapezoid_right_down_anchor)
...
def test_all_anchors_and_plot_update(plot_instance, qtbot):
    ...
    plot_instance.trapezoid_left_down_anchor.sigPositionChanged.emit(plot_instance.trapezoid_left_down_anchor)
    plot_instance.trapezoid_left_up_anchor.sigPositionChanged.emit(plot_instance.trapezoid_left_up_anchor)
    plot_instance.trapezoid_right_up_anchor.sigPositionChanged.emit(plot_instance.trapezoid_right_up_anchor)
    plot_instance.trapezoid_right_down_anchor.sigPositionChanged.emit(plot_instance.trapezoid_right_down_anchor)
